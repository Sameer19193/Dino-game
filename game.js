...
let dyno = document.createElement('div');
dyno.setAttribute('class', 'dyno');
gameArea.appendChild(dyno);
player.x = dyno.offsetLeft;
player.y = dyno.offsetTop;
}
...
//play the game
function Play() {
let dyno = document.querySelector('.car');
...
dyno.style.top = player.y + "px";
dyno.style.left = player.x + "px";
